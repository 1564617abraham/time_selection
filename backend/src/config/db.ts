...
const connectDB = async () => {
    try {
        ...
        //NODE_ENV => logica de scripts en package.json
        ...
        console.log('Make sure MongoDB is installed and running (https://www.mongodb.com/docs/manual/installation/) and then set the MONGODB_URI in your .env file.')
    }
}
